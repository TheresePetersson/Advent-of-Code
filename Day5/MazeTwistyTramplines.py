...
# come across an offset of 3, you would move three instructions forward,
...
with open("input.txt") as f:
    for line in f:
        int_list = line.strip()
        int_lst.append(int(int_list))

while index < len(int_lst):
	element = int_lst[index]
	int_lst[index] = element+1
	index += element
	count += 1
